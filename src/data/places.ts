...
export const historicalPlaces: HistoricalPlace[] = [
  ...
  },
  {
    ...
    description:
      "The Great Wall of China is a series of fortifications and walls that were built across the historical northern borders of ancient Chinese states and Imperial China.",
    image:
  ...
  },
  {
    ...
    image:
      "https://images.pexels.com/photos/259967/pexels-photo-259967.jpeg?auto=compress&cs=tinysrgb&w=1200",
    location: "Peru",
    yearBuilt: 1450,
    visited: false,
  },
  ...
  },
  {
    ...
    name: "Stonehenge",
    description:
      "Stonehenge is a prehistoric monument consisting of a ring of standing stones, each around 13 feet high, seven feet wide, and weighing around 25 tons.",
    ...
    image:
      "https://cdn.mos.cms.futurecdn.net/q4i42ws72RZ3sEcx2QT3iV-650-80.jpg.webp",
  ...
  },
  {
    ...
    description:
      "The Giza pyramid complex is an archaeological site on the Giza plateau, on the outskirts of Cairo, Egypt. It includes the three main pyramids, the Great Sphinx, and several cemeteries.",
    image:
  ...
  },
  {
    ...
    image:
      "https://www.ancient-origins.net/sites/default/files/styles/article_image/public/field/image/Petra-Jordan-Ad-Deir-Monastery.jpg?itok=1mCSC4me",
    location: "Jordan",
    yearBuilt: -300,
    visited: false,
  },
  {
    ...
    image: "https://smarthistory.org/wp-content/uploads/2023/11/799603181_d199a81331_o.jpg",
    location: "Cambodia",
    yearBuilt: 1113,
    visited: false,
  },
